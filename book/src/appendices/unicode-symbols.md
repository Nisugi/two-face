...
- [Display Issues](../troubleshooting/display-issues.md) - Character problems
- [Creating Themes](../customization/creating-themes.md) - Using symbols
- [Platform Issues](../troubleshooting/platform-issues.md) - Font setup
